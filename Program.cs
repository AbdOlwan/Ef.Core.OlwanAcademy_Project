using EF.InitialMigration.Data;
using Microsoft.EntityFrameworkCore;
using System;

namespace EF.InitialMigration
{
        ...
        public static void Main(string[] args)
        {
            using (var context = new AppDbContext())
            {
                ...
                foreach (var section in sections)
                {
                   ...
                   //  Console.WriteLine($"| {section.Id.ToString().PadLeft(2, '0')} | {section.Course.CourseName,-12} | {section.SectionName,-7} | {(section.Instructor?.FName + " " + section.Instructor?.LName),-20} | {section.Schedule.Title,-14} | {"08:00:00     ",-9} | {sunday,-3} | {monday,-3} | {tuesday,-3} | {wednesday,-3} | {thursday,-3} | {friday,-3} | {saturday,-3} |");
